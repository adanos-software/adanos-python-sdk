...
All notable changes to `social-stock-sentiment` will be documented in this file.
...
### Added
- First public standalone `social-stock-sentiment` repository under `adanos-software/social-stock-sentiment`.
