...
if TYPE_CHECKING:
    from ..models.x_search_summary import XSearchSummary


T = TypeVar("T", bound="XSearchResultItem")


@_attrs_define
class XSearchResultItem:
    """Individual X/Twitter search result item.

    Attributes:
        ticker (str): Stock ticker symbol
        name (str): Company name
        summary (XSearchSummary): Compact recent-period summary attached to X search results.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        summary = XSearchSummary.from_dict(d.pop("summary"))
        ...
        x_search_result_item.additional_properties = d
        return x_search_result_item
