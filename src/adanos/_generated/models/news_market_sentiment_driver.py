...
T = TypeVar("T", bound="NewsMarketSentimentDriver")


@_attrs_define
class NewsMarketSentimentDriver:
    """Top asset contributing to the service-level News market sentiment.

    Attributes:
        ticker (str): Stock ticker symbol
        mentions (int): News mentions in the selected period
        buzz_score (float): Asset buzz score in the selected period
        sentiment_score (float | None | Unset): Average news sentiment score for this asset
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        news_market_sentiment_driver = cls(
            ticker=ticker,
            mentions=mentions,
            buzz_score=buzz_score,
        ...
        news_market_sentiment_driver.additional_properties = d
        return news_market_sentiment_driver
