...
if TYPE_CHECKING:
    from ..models.news_search_summary import NewsSearchSummary


T = TypeVar("T", bound="NewsSearchResultItem")
...
class NewsSearchResultItem:
    ...
    Attributes:
        ...
        summary (NewsSearchSummary): Compact recent-period summary attached to news search results.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        summary = NewsSearchSummary.from_dict(d.pop("summary"))
        ...
        news_search_result_item.additional_properties = d
        return news_search_result_item
