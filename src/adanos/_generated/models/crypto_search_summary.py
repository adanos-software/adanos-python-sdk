...
from ..models.crypto_search_summary_trend_type_0 import CryptoSearchSummaryTrendType0
from ..types import UNSET, Unset

T = TypeVar("T", bound="CryptoSearchSummary")


@_attrs_define
class CryptoSearchSummary:
    """Compact recent-period summary attached to crypto search results.
    ...
    Attributes:
        ...
        trend (CryptoSearchSummaryTrendType0 | None | Unset): Activity/attention trend over current 3 UTC days vs
            previous 3 UTC days, not price trend
    ...
    subreddit_count: int
    total_upvotes: int
    trend: CryptoSearchSummaryTrendType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.trend, Unset):
            trend = UNSET
        elif isinstance(self.trend, CryptoSearchSummaryTrendType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_trend(data: object) -> CryptoSearchSummaryTrendType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                trend_type_0 = CryptoSearchSummaryTrendType0(data)

                return trend_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CryptoSearchSummaryTrendType0 | None | Unset, data)
        ...
        crypto_search_summary.additional_properties = d
        return crypto_search_summary
