...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[XTrendingCountry]
]:
    return Response(
...
def sync_detailed(
    ...
    **Pagination**: Use `offset` and `limit` to paginate through results.
    ...
    Returns:
        Response[ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[XTrendingCountry]]
    """
