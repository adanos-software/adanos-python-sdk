...
) -> ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | NewsRawMentionsResponse | RateLimitError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | NewsRawMentionsResponse | RateLimitError]:
    return Response(
...
def sync(
    ...
    **Professional account required.** Free and Hobby accounts cannot use this endpoint.
    ...
    Returns:
        ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | NewsRawMentionsResponse | RateLimitError
    """
