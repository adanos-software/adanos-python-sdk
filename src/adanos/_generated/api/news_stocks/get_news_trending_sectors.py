...
from ...models.news_trending_sector import NewsTrendingSector
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/news/stocks/v1/trending/sectors",
        "params": params,
    }
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = NewsTrendingSector.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Any | ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[NewsTrendingSector]]
    """
...
def sync(
    *,
    ...
    Returns:
        Any | ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[NewsTrendingSector]
    """
