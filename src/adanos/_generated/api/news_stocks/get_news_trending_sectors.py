...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Any | ErrorResponse | HTTPValidationError | HistoricalLimitError | list[NewsTrendingSector]]
    """
...
def sync(
    *,
    ...
    Returns:
        Any | ErrorResponse | HTTPValidationError | HistoricalLimitError | list[NewsTrendingSector]
    """
