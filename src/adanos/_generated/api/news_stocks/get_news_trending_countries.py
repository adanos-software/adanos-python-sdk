...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Any | ErrorResponse | HTTPValidationError | HistoricalLimitError | list[NewsTrendingCountry]]
    """
...
def sync(
    *,
    ...
    Returns:
        Any | ErrorResponse | HTTPValidationError | HistoricalLimitError | list[NewsTrendingCountry]
    """
