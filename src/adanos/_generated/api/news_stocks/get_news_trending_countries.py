...
from ...models.news_trending_country import NewsTrendingCountry
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/news/stocks/v1/trending/countries",
        "params": params,
    }
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = NewsTrendingCountry.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        source (None | str | Unset): Optional source filter (strict canonical source id or known
            alias)
    ...
    Returns:
        Response[Any | ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[NewsTrendingCountry]]
    """
...
def sync(
    *,
    ...
    Returns:
        Any | ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[NewsTrendingCountry]
    """
