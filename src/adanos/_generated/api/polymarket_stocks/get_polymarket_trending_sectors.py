...
from ...models.polymarket_trending_sector import PolymarketTrendingSector
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/polymarket/stocks/v1/trending/sectors",
        "params": params,
    }
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = PolymarketTrendingSector.from_dict(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[PolymarketTrendingSector]]
    """
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[PolymarketTrendingSector]
    """
