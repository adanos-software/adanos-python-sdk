...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/polymarket/stocks/v1/search",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PolymarketSearchResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Search stocks on Polymarket

     Search ticker_reference and enrich with Polymarket trade-count stats.
