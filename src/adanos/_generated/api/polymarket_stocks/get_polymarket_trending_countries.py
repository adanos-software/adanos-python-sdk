...
from ...models.polymarket_trending_country import PolymarketTrendingCountry
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/polymarket/stocks/v1/trending/countries",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | list[PolymarketTrendingCountry]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = PolymarketTrendingCountry.from_dict(
...
def sync_detailed(
    *,
    ...
    """Get trending countries on Polymarket
     ...
     Get country-level aggregation for Polymarket stocks.
    ...
    Args:
        ...
        limit (int | Unset): Maximum countries to return Default: 20.
    ...
    Returns:
        Response[ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[PolymarketTrendingCountry]]
    """
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | InvalidPeriodError | HistoricalLimitError | list[PolymarketTrendingCountry]
    """
