...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ErrorResponse | HTTPValidationError | HistoricalLimitError | list[PolymarketTrendingSector]]
    """
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | HistoricalLimitError | list[PolymarketTrendingSector]
    """
