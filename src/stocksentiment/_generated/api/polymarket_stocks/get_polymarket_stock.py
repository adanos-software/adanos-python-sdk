...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | ErrorResponse | HTTPValidationError | HistoricalLimitError | PolymarketStockDetailResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ErrorResponse | HTTPValidationError | HistoricalLimitError | PolymarketStockDetailResponse
    """
