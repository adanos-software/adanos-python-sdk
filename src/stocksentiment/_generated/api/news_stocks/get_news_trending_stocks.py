...
from ...models.get_news_trending_stocks_type_type_0 import (
...
def _get_kwargs(
    *,
    ...
    if isinstance(type_, Unset):
        json_type_ = UNSET
    elif isinstance(type_, GetNewsTrendingStocksTypeType0):
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = NewsTrendingStock.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    """Get trending stocks from news
     ...
     List trending stocks in the news dataset ranked by the news buzz score, with optional source
    filtering.
    ...
    Args:
        ...
        type_ (GetNewsTrendingStocksTypeType0 | None | Unset): Filter by asset type. Omit or use
            'all' for all assets.
