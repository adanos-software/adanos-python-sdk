...
if TYPE_CHECKING:
    from ..models.compare_stock_item import CompareStockItem
...
class CompareResponse:
    ...
    Attributes:
        ...
        stocks (list[CompareStockItem]): Stocks sorted by buzz_score descending
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for stocks_item_data in _stocks:
            stocks_item = CompareStockItem.from_dict(stocks_item_data)
