...
T = TypeVar("T", bound="CryptoSchedulerStatus")


@_attrs_define
class CryptoSchedulerStatus:
    """Crypto worker heartbeat status.

    Attributes:
        running (bool): Whether worker heartbeat is fresh
        last_scrape (None | str | Unset): Last scrape timestamp
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        crypto_scheduler_status.additional_properties = d
        return crypto_scheduler_status
